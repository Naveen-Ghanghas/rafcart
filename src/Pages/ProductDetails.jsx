    ...
    <div class="container grid grid-cols-2 gap-6">
        <div>
            ...
            <div class="grid grid-cols-5 gap-4 mt-4">
                <img src={product2} alt="product2" class="w-full cursor-pointer border border-primary"/>
            ...
            <div class="pt-4">
                ...
                <div class="flex items-center gap-2">
                    <div class="color-selector">
                        ...
                        <label for="red"class="border border-gray-200 rounded-sm h-6 w-6  cursor-pointer shadow-sm block bg-[#fc3d5]"></label>
                    </div>
                    <div class="color-selector">
                        <input type="radio" name="color" id="black" class="hidden"/>
                        <label for="black"
                            className="border border-gray-200 rounded-sm h-6 w-6  cursor-pointer shadow-sm block bg-[#000]"></label>
                    </div>
                    <div class="color-selector">
